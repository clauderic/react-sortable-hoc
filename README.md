...
| pressDelay                 | Number \| Function           | `0`                                                                                                        | If you'd like elements to only become sortable after being pressed for a certain time, change this property. A good sensible default value for mobile is `200`. Cannot be used in conjunction with the `distance` prop. Also accepts a function to allow for more flexibility. Function must return a number.  `function(event)`                                                                                                                                    |
