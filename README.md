...
| dropAnimationDuration      | Number                                                | `250`                                                                                                          | Controls the duration of the drop animation. Set to `0` to disable the animation entirely                                                                                                                                                                                                                                                                                                                                                                              |
| dropAnimationEasing        | String                                                | `"cubic-bezier(0.19, 1, 0.1, 1)"`                                                                              | Controls the easing of the drop animation. Supports any easing supported by the `transition` CSS property, see https://easings.net/ for more.                                                                                                                                                                                                                                                                                                                          |
