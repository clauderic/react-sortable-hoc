...
| translatableSelector     | String             |                                                                                                             | Instead of applying CSS transforms to the SortableElement, apply them to the descendant elements found by this selector (useful if SortableElement is `display:table-row` as IE & Edge won't apply the transform.)
