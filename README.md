...
| keySortingTransitionDuration| Number                                                | transitionDuration                                                                                             | The duration of the transition when the helper is shifted during keyboard sorting. Set this to `0` if you'd like to disable transitions for the keyboard sorting helper                                                                                                                                                                                                                                                                                                       |
