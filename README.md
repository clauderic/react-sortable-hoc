...
| cloneComputedStyles          | Boolean           | `false`                                                                                                     | You can clone all computed properties into an element's copy. This resolves the issue, when `<tr>` with multiple `<td>` is being moved.                                                                                                                                                                                                                                           |
