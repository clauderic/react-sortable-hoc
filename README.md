...
| beforeSortStart            | Function / Promise|                                                                                                            | Callback that is invoked before sorting begins. The callback can return a promise. `function({node, index, collection}, event)`
