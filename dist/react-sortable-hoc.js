    ...
    },
    {
      ...
      value: function update(_ref) {
        ...
        var translate = _ref.translate,
          ...
          width = _ref.width,
          height = _ref.height;
        var scrollXStartDistance = this.scrollXStartDistance;
        var scrollYStartDistance = this.scrollYStartDistance;
        var direction = {
          x: 0,
          y: 0,
        };
        ...
        if (
          translate.y >= maxTranslate.y - height / 2 - scrollYStartDistance &&
          !isBottom
        ) {
          direction.y = 1;
          speed.y =
          ...
          translate.x >= maxTranslate.x - width / 2 - scrollXStartDistance &&
          !isRight
        ) {
          direction.x = 1;
          speed.x =
          ...
          translate.y <= minTranslate.y + height / 2 + scrollYStartDistance &&
          !isTop
        ) {
          direction.y = -1;
          speed.y =
          ...
          translate.x <= minTranslate.x + width / 2 + scrollXStartDistance &&
          !isLeft
        ) {
          direction.x = -1;
          speed.x =
          ...
          value: function componentDidMount() {
            ...
            var _this$props6 = this.props,
              useWindowAsScrollContainer =
                _this$props6.useWindowAsScrollContainer,
              scrollXStartDistance = _this$props6.scrollXStartDistance,
              scrollYStartDistance = _this$props6.scrollYStartDistance;
        ...
        },
        {
          ...
          value: function updateHelperPosition(event) {
            var _this$props7 = this.props,
              lockAxis = _this$props7.lockAxis,
              lockOffset = _this$props7.lockOffset,
              lockToContainerEdges = _this$props7.lockToContainerEdges,
              transitionDuration = _this$props7.transitionDuration,
              _this$props7$keyboard =
                _this$props7.keyboardSortingTransitionDuration,
              keyboardSortingTransitionDuration =
                _this$props7$keyboard === void 0
                  ? transitionDuration
                  : _this$props7$keyboard;
        ...
        },
        {
          ...
          value: function animateNodes() {
            var _this$props8 = this.props,
              ...
              hideSortableGhost = _this$props8.hideSortableGhost,
              onSortOver = _this$props8.onSortOver;
