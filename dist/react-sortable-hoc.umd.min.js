!(function(e, t) {
  ...
  function B(e, t) {
    ...
    if (e) {
      var o = {
        left: n.left + e.getBoundingClientRect().left,
        top: n.top + e.getBoundingClientRect().top,
      };
      return e.parentNode === t ? o : B(e.parentNode, t, o);
    }
  }
  function G(e) {
    var t = e.lockOffset,
  ...
  function $(n) {
    ...
    return (
          ...
          f(t, [
            ...
            },
            {
              ...
              value: function() {
                ...
                return r.createElement(n, l({ref: e}, this.props));
              },
            },
          ]),
          t
      ...
      c(e, 'displayName', L('sortableHandle', n)),
      t
    );
  }
  function J(e) {
  ...
  var Z = {
    ...
    ee = {lift: [q], drop: [q], cancel: [X], up: [Y, U], down: [V, F]},
    te = {
      axis: 'y',
      disableAutoscroll: !1,
      distance: 0,
  ...
  function oe(t) {
    ...
    return (
          ...
          return (
                          ...
                          var e,
                            ...
                            u =
                              ...
                              (o = window.getComputedStyle(n)).display
                                ? {x: j(o.gridColumnGap), y: j(o.gridRowGap)}
                                : {x: 0, y: 0}),
                            d = R.scrollContainer.getBoundingClientRect(),
                            f = b({index: s, node: T, collection: k});
                          if (
                            ((R.node = T),
                            (R.margin = c),
                            (R.gridGap = u),
                            ...
                            (R.helper = R.helperContainer.appendChild(
                              ...
                              (l = r.cloneNode(!0)),
                              N(l.querySelectorAll(i)).forEach(function(e, t) {
                            ...
                            I && R.helper.focus(),
                            S && M((R.sortableGhost = T), {opacity: 0}),
                            (R.minTranslate = {}),
                            (R.maxTranslate = {}),
                            I)
                          ) {
            ...
            c(p(p(R)), 'handleSortEnd', function(e) {
              ...
              R.listenerNode &&
                ...
                n && R.sortableGhost && M(R.sortableGhost, {opacity: ''});
            ...
            c(p(p(R)), 'keyMove', function(e) {
              ...
              if (!(o < 0 || n < o)) {
                ...
                var i,
                  ...
                  g = f.left + h.x - d.left,
                  y = r < o,
                  v = y && R.axis.x ? u.offsetWidth - R.width : 0,
                  m = y && R.axis.y ? u.offsetHeight - R.height : 0;
                R.handleSortMove({
                  pageX: g + v,
                  pageY: p + m,
        ...
        return (
          ...
          f(n, [
                ...
                Promise.resolve(e).then(function(e) {
                  ...
                  (n.contentWindow = 'function' == typeof t ? t() : t),
                    (n.scrollContainer = o
                      ...
                      : _(n.container, n.props.scrollContainer) || n.container),
                ...
                if (
                  ...
                  var f = (function(e) {
                      ...
                      return [
                        ...
                        G({height: t, lockOffset: l, width: n}),
                      ];
                          ...
                          ? this.axis.y
                            ? b ||
                              ...
                              : (x ||
                                ...
                                (this.newIndex = p))
                            : x || (p > this.index && l + i.left + m >= S.left)
                            ? ((w.x = -(this.width + this.marginOffset.x)),
                              (this.newIndex = p))
                            : (b ||
                                (p < this.index && l + i.left <= S.left + m)) &&
                              ((w.x = this.width + this.marginOffset.x),
                              null == this.newIndex && (this.newIndex = p))
                          : this.axis.y &&
                            (x ||
                            (p > this.index &&
                              s + i.top + this.boundingClientRect.height >=
                                S.top + v)
                              ? ((w.y = -(this.height + this.marginOffset.y)),
                                (this.newIndex = p))
                              : (b ||
                                  (p < this.index && s + i.top <= S.top + v)) &&
                                ((w.y = this.height + this.marginOffset.y),
                                null == this.newIndex && (this.newIndex = p))),
                        E(h, w),
                        (a[d].translate = w))
                      : n && M((this.sortableGhost = h), {opacity: 0});
                }
            ...
            },
            {
              ...
              value: function() {
                var e = o.withRef ? 'wrappedInstance' : null;
                return r.createElement(t, l({ref: e}, k(this.props, ne)));
              },
            },
            {
              key: 'helperContainer',
      ...
      c(e, 'displayName', L('sortableList', t)),
      c(e, 'defaultProps', te),
      c(e, 'propTypes', Z),
  ...
  function ae(n) {
    ...
    return (
        ...
        return (
          ...
          f(t, [
            ...
            },
            {
              ...
              value: function() {
                var e = o.withRef ? 'wrappedInstance' : null;
                return r.createElement(n, l({ref: e}, k(this.props, ie)));
              },
            },
          ]),
          t
      ...
      c(e, 'displayName', L('sortableElement', n)),
